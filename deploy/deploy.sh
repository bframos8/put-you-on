...
# 6. Health gate: a bad deploy should fail the job, not sit there silently broken. Through
...
# 7. Reclaim disk. -af, not -f: plain prune only removes *dangling* images, and SHA-tagged
