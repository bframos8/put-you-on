...
SECURESTRING_KEYS="SESSION_SECRET TOKEN_ENCRYPTION_KEYS SPOTIFY_CLIENT_ID SPOTIFY_CLIENT_SECRET SENTRY_DSN POSTGRES_USER POSTGRES_PASSWORD POSTGRES_DB GRAFANA_PROM_TOKEN"
STRING_KEYS="POSTGRES_HOST POSTGRES_PORT SPOTIFY_REDIRECT_URI FRONTEND_URL CORS_ALLOWED_ORIGINS ENABLE_HSTS SENTRY_ENVIRONMENT SENTRY_TRACES_SAMPLE_RATE SPOTIFY_HTTP_TIMEOUT OAUTH_STATE_TTL_SECONDS LOG_LEVEL GRAFANA_PROM_URL GRAFANA_PROM_USER"
